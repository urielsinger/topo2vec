...
def load_model_from_file(final_model_name='final_model81624.pt',
...
topo_resnet_full = load_model_from_file(
    'classifier_TopoResNet_224224224_lr_0.000920019…_classes_4_latent_size_50_train_all_resnet_True.pt',
    RESNET_HPARAMS)

topo_resnet_transfer = load_model_from_file(
    'classifier_TopoResNet_224224224_lr_0.0009200196593708_size_10000_num_classes_4_latent_size_50.pt',
    RESNET_HPARAMS)
...
amphib_autoencoder = load_model_from_file(
    'autoencoder_AdvancedAmphibAutoencoder_81624classes_4_latent_size_30_train_all_resnet_False.pt',
    AE_HPARAMS)
