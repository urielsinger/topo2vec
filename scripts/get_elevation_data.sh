#!/usr/bin/env bash
EARTH_LOCATION=$1
SAVE_LOCATION='/home/morpheus/topo2vec_kavitzky/repositories/topo2vec/data/downloads/'${EARTH_LOCATION}'.tar.gz'
LINK='133.56.96.210/ALOS/aw3d30/data/release_v1903/'${EARTH_LOCATION}'.tar.gz'
EXTRACT_LOCATION='/home/morpheus/topo2vec_kavitzky/repositories/topo2vec/data/elevation'
